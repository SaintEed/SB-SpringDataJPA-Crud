package com.deusnex.springboot.cruddemo.rest;
...
import com.deusnex.springboot.cruddemo.service.EmployeeService;
...
public class EmployeeRestController {
	...
	public Employee getEmployee(@PathVariable int employeeId) {
		...
		if (theEmployee == null) {
			throw new RuntimeException("Employeee id is not found - " + employeeId);
		}
	...
	//also just in case they pass an id in JSON...set id tp 0
